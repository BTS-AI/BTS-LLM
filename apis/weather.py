...
keys = os.getenv("KOREA_WEATHER_API")
...
# forecast 함수로 받은 결과를 텍스트로 정리해주는 함수
def proc_weather(location): #location
    dict_sky = forecast()
...
# print(proc_weather("서울"))
# print(type(proc_weather("서울")))
