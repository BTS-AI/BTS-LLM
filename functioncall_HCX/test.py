...
from apis.gpt_api import gpt_3model, gpt_4model  # GPT model
from apis.gpt_api import client  # openai client
...
def ask_gpt_functioncall(query):
    ...
    try:
        ...
        if first_response and first_response.choices:
            ...
            print("No valid response from GPT model.")
            return None
...
print(ask_gpt_functioncall("요즘 유행하는 반팔티 추천해줘"))
